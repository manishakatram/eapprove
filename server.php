...
if (isset($_POST['reg_user'])) {
  ...
  $username = mysqli_real_escape_string($db, $_POST['username']);<?php
session_start();
...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
    ...
    //make a folder on the physical machine for each registered user
    // $curdir = getcwd();
    // if(mkdir($curdir ."/uploads/$username", 0777)){
    //   echo "Directoy create";
    // } else {
    //   echo "didnt create";
    // }
